...
include "header.php";
// set the tpl page
$page = "edit_buy_transactions.tpl";
...
else 
{
	...
	if ($module == 'trx' && $act == 'edit')
	{
		...
		$queryTrx = "SELECT A.detailID, B.productBuyPrice, A.detailBuyPrice, A.detailBuyQty, B.productBarcode, B.productName, B.productID FROM as_buy_detail_transactions A
		...
		$smarty->assign("detailBuyQty", $dataTrx['detailBuyQty']);
		$smarty->assign("detailBuyPrice", $dataTrx['detailBuyPrice']);
