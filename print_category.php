...
if ($_SESSION['userName'] == '' && $_SESSION['userPassword'] == '')
{
	...
	$content = "<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 203mm;'>
				...
				<p style='width: 210mm; font-size: 11pt;'><span style='font-size: 10pt;'>DATA KATEGORI</span></p>
				<table cellpadding='0' cellspacing='0' style='width: 210mm;'>
					<tr>
						<th style='width: 10mm;'>No.</th>
						<th style='width: 70mm;'>Nama Kategori</th>
					...
					while ($dtCategory = mysqli_fetch_array($sqlCategory))
					{
						...
						$content .= "
							<tr valign='top'>
								...
								<td style='padding: 5px 0px 5px 0px; font-size: 10pt;'>$dtCategory[categoryStatus]</td>
							</tr>
						";
						$i++;
					}
