...
if ($_SESSION['userName'] == '' && $_SESSION['userPassword'] == '')
{
	...
	$content = "<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 240mm;'>
				...
				<table cellpadding='0' cellspacing='0' style='width: 240mm;'>
					...
					<tr>
						<td style='font-size: 12pt;'>Nopol</td>
						<td style='font-size: 12pt;'>:</td>
						<td style='font-size: 12pt;'>$dataTrx[nopol]</td>
		...
		$content .= 
					"<tr>
						...
						<td align='right' style='font-size: 12pt; padding: 5px; border-top: 1px solid #999999; border-bottom: 1px solid #999999; width: 30mm;'><b>Grandtotal</b></td>
						<td align='right' style='font-size: 12pt; padding: 5px; border-top: 1px solid #999999; border-bottom: 1px solid #999999; width: 5mm;'>:</td>
						<td style='font-size: 12pt; padding: 5px; border-top: 1px solid #999999; border-bottom: 1px solid #999999; width: 50mm;' align='right'><b>$total</b></td>
					</tr>
					<tr>
						...
						<td align='right' style='font-size: 12pt; padding: 5px; border-bottom: 1px solid #999999;'></td>
						<td align='right' style='font-size: 12pt; padding: 5px; border-bottom: 1px solid #999999;'>Bayar</td>
					...
					<tr>
						<td align='right' style='font-size: 12pt; padding: 5px; border-bottom: 1px solid #999999;'>PPN ($dataIdentity[identityPPN]%)</td>
						<td align='right' style='font-size: 12pt; padding: 5px; border-bottom: 1px solid #999999;'>:</td>
				...
				<table cellpadding='0' cellspacing='0' style='width: 240mm;'>
					...
					<tr>
						...
						<td style='font-size: 12pt; padding: 5px 0px 5px 0px;'>TOTAL MASUK</td>
				...
				<p style='font-size: 12pt; font-weight: bold; text-decoration: underline;'>Sisa Bayar : Rp. $sisa</p>
