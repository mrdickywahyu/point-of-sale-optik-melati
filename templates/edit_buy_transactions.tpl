			...
			<td>
				...
				<table cellpadding="7" cellspacing="7">
					...
					<tr>
						...
						<td>:</td>
						<td><input type="text" id="price" name="price" value="{$detailBuyPrice}" style="display: block; width: 270px; height: 34px; padding: 6px 12px; font-size: 14px; line-height: 1.428571429; color: #555; background-color: #fff; border: 1px solid #ccc; border-radius: 4px;" required></td>
					</tr>
					<tr>
						<td>Qty</td>
						<td>:</td>
						<td><input type="text" id="qty" name="qty" value="{$detailBuyQty}" style="display: block; width: 270px; height: 34px; padding: 6px 12px; font-size: 14px; line-height: 1.428571429; color: #555; background-color: #fff; border: 1px solid #ccc; border-radius: 4px;" required></td>
					</tr>
				</table>
