			...
			<div class="scroller-inner">
				...
				{if $module == 'report' AND $act == 'search'}
					<table width="98%" align="center">
						...
						<tr>
							<td><br><a href="print_sp_fund_reports.php?module=report&act=print&startDate={$start}&endDate={$end}&outletID={$oID}" target="_blank"><button type="button" class="btn btn-warning">Print</button></a></td>
						</tr>
					</table>
					<p>&nbsp;</p>
