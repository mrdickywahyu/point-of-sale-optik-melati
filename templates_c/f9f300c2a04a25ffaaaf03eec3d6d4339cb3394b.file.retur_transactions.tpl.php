<?php /* Smarty version Smarty-3.1.11, created on 2019-09-18 22:09:45
         compiled from ".\templates\retur_transactions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:318505d8248b9e6ca95-92094472%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9f300c2a04a25ffaaaf03eec3d6d4339cb3394b' => 
    array (
      0 => '.\\templates\\retur_transactions.tpl',
      1 => 1413905610,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '318505d8248b9e6ca95-92094472',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d8248ba093d89_11082600',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d8248ba093d89_11082600')) {function content_5d8248ba093d89_11082600($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
									...
									<table cellpadding="7" cellspacing="7">
										<tr>
											<td style="padding-top: 15px;">Kode Produk :<br>
												...
												<input type="hidden" name="supplierIDS" size="40" id="supplierIDS" value="<?php echo $_smarty_tpl->tpl_vars['supplierCode']->value;?>
">
											</td>
										</tr>
										<tr>
							...
							<td width="80%" bgcolor="#389c1d" style="padding: 10px 0px 0px 10px;">
								...
								<table>
									<tr>
										...
										<td width="350">: <?php echo $_smarty_tpl->tpl_vars['fakturRetur']->value;?>
<input type="hidden" name="fakturRetur" size="40" id="fakturRetur" value="<?php echo $_smarty_tpl->tpl_vars['fakturRetur']->value;?>
"></td>
										<td width="90">ID Supplier</td>
										<td>: <input type="text" name="supplierID" size="40" id="supplierID" value="<?php echo $_smarty_tpl->tpl_vars['supplierCode']->value;?>
"></td>
									</tr>
									<tr>
										<td>Tanggal</td>
...
?>
											    	<tr valign="top">
											    		...
											    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;'><?php echo $_smarty_tpl->tpl_vars['dataShow']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataShow']['index']]['detailReturPrice'];?>
</td>
											    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;'><?php echo $_smarty_tpl->tpl_vars['dataShow']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataShow']['index']]['detailReturQty'];?>
</td>
											    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;'><?php echo $_smarty_tpl->tpl_vars['dataShow']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataShow']['index']]['detailReturSubtotal'];?>
</td>
											    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;'>
											    			<a href="edit_retur_transactions.php?module=trx&act=edit&detailID=<?php echo $_smarty_tpl->tpl_vars['dataShow']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataShow']['index']]['detailID'];?>
" data-width="520" data-height="320" class="various2 fancybox.iframe"><img src="images/icons/edit.png" width="20"></a>
											    			<a href="retur_transactions.php?module=trx&act=delete&detailID=<?php echo $_smarty_tpl->tpl_vars['dataShow']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataShow']['index']]['detailID'];?>
&supplierID=<?php echo $_smarty_tpl->tpl_vars['supplierCode']->value;?>
								...
								<form id="frm_trx2" name="frm_trx2" action="save_detail_retur_trx.php" method="POST">
									<table cellpadding="7" cellspacing="7">
										<tr>
											<td style="padding-top: 15px;">Kode Produk :<br>
												<input type="text" name="productBarcode" placeholder="Masukkan kode produk disini" id="productBarcode" style="display: block; width: 244px; height: 20px; padding: 6px 12px; font-size: 14px; line-height: 1.428571429; color: #555; background-color: #fff; border: 1px solid #ccc; border-radius: 4px;" required autofocus>
												<input type="hidden" name="fakturRetur" size="40" id="fakturRetur" value="<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
">
												<input type="hidden" name="supplierIDS" size="40" id="supplierIDS" value="<?php echo $_smarty_tpl->tpl_vars['supplierCode']->value;?>
">
											</td>
							...
							<td width="80%" bgcolor="#389c1d" style="padding: 10px 0px 0px 10px;">
								...
								<table>
									<tr>
										<td width="130">Nomor Retur</td>
										<td width="350">: <?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
<input type="hidden" name="fakturRetur" size="40" id="fakturRetur" value="<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
"><input type="hidden" name="trxID" size="40" id="trxID" value="<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
"></td>
										<td width="90">ID Supplier</td>
										<td>: <input type="text" name="supplierIDD" size="40" id="supplierIDD" value="<?php echo $_smarty_tpl->tpl_vars['supplierCode']->value;?>
"></td>
									</tr>
									<tr>
										<td>Tanggal</td>
										<td>: <?php echo $_smarty_tpl->tpl_vars['trxDate']->value;?>
</td>
										<td>Nama</td>
...
?>
											    	<tr valign="top">
											    		...
											    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;'>
											    			<a href="edit_retur_transactions.php?module=trx&act=edit&detailID=<?php echo $_smarty_tpl->tpl_vars['dataShow']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataShow']['index']]['detailID'];?>
" data-width="520" data-height="320" class="various2 fancybox.iframe"><img src="images/icons/edit.png" width="20"></a>
											    			<a href="retur_transactions.php?module=trx&act=deleteedit&detailID=<?php echo $_smarty_tpl->tpl_vars['dataShow']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataShow']['index']]['detailID'];?>
&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
...
" name="total" id="total">
				...
				<?php }elseif($_smarty_tpl->tpl_vars['module']->value=='trx'&&$_smarty_tpl->tpl_vars['act']->value=='preview'){?>
					...
					<table align="center" width="850">
						<tr>
							<td>
								<a href="retur_transactions.php?module=trx&act=edit&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
"><button type="button" class="btn btn-primary">Edit Transaksi</button></a> 
								<!--<a href="print_retur_transactions.php?module=trx&act=print&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
" target="_blank"><button type="button" class="btn btn-success">Print</button></a>-->
								<?php if ($_smarty_tpl->tpl_vars['identityPrintRetur']->value=='1'){?>
									<a onclick="finish_confirm('Transaksi retur selesai, transaksi retur baru?','retur_transactions.php?module=trx&act=finish&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
','print_retur_transactions.php?module=trx&act=print&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
');"><button type="button" class="btn btn-info">Transaksi Selesai</button></a>
								<?php }else{ ?>
									<a onclick="finish_confirm('Transaksi retur selesai, transaksi retur baru?','retur_transactions.php?module=trx&act=finish&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
','print_mini_retur_transactions.php?module=trx&act=print&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
');"><button type="button" class="btn btn-info">Transaksi Selesai</button></a>
								<?php }?>
								<!--<a href="retur_transactions.php?module=trx&act=finish&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
" onclick="return confirm('Transaksi retur selesai, transaksi retur baru?');"><button type="button" class="btn btn-info">Transaksi Selesai</button></a>-->
							</td>
						</tr>
					</table>
 ...
 <?php }?> </td>
						...
						<tr valign="top">
							<td>Cirebon, <?php echo $_smarty_tpl->tpl_vars['trxDate']->value;?>
</td>
							<td><?php if ($_smarty_tpl->tpl_vars['trxPhone']->value!=''){?> <?php echo $_smarty_tpl->tpl_vars['trxPhone']->value;?>
 <?php }?></td>
						</tr>
						<tr>
							<td colspan="2"><br>Nomor Retur : <?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
</td>
						</tr>
					</table>
...
?>
					    	<tr valign="top">
					    		...
					    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC; text-align: right;'><?php echo $_smarty_tpl->tpl_vars['dataDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDetail']['index']]['detailReturPrice'];?>
</td>
					    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC; text-align: center;'><?php echo $_smarty_tpl->tpl_vars['dataDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDetail']['index']]['detailReturQty'];?>
</td>
					    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC; text-align: right;'><?php echo $_smarty_tpl->tpl_vars['dataDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDetail']['index']]['detailReturSubtotal'];?>
</td>
					    	</tr>
					    	<?php endfor; endif; ?>
					    </tbody>
					...
					<table align="center" width="850">
						<tr valign="top">
							...
							<td>: Rp. <?php echo $_smarty_tpl->tpl_vars['trxTotal']->value;?>
</td>
						</tr>
						<tr>
							<td colspan="4">&nbsp;</td>
...
?>
											    	<tr class="borderedtd">
											    		...
											    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC; font-style: 14pt;'><?php echo $_smarty_tpl->tpl_vars['dataTrx']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataTrx']['index']]['invoiceReturID'];?>
</td>
											    		...
											    		<td style='border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC; font-style: 14pt; text-align: center;'>
											    			<a href="retur_transactions.php?module=trx&act=previewdetail&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['dataTrx']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataTrx']['index']]['invoiceReturID'];?>
...
" title="Lihat Detail"><img src="images/icons/view.png" width="20">
											    			<a href="retur_transactions.php?module=trx&act=deletetrx&type=<?php echo $_smarty_tpl->tpl_vars['type']->value;?>
&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['dataTrx']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataTrx']['index']]['invoiceReturID'];?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['dataTrx']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataTrx']['index']]['trxID'];?>
...
" onclick="return confirm('Anda Yakin ingin menghapus retur <?php echo $_smarty_tpl->tpl_vars['dataTrx']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataTrx']['index']]['invoiceReturID'];?>
? Kami menyarankan agar transaksi tidak boleh hapus!, kecuali karena kesalahan.');" title="Hapus Transaksi"><img src="images/icons/delete.png" width="20"></td>
											    	</tr>
											    	<?php endfor; endif; ?>
											    </tbody>
											</table>
...
" target="_blank"><button type="button" class="btn btn-success">Print</button></a>
								<?php }else{ ?>
									<a href="print_mini_retur_transactions.php?module=trx&act=print&invoiceReturID=<?php echo $_smarty_tpl->tpl_vars['invoiceReturID']->value;?>
&trxID=<?php echo $_smarty_tpl->tpl_vars['trxID']->value;?>
" target="_blank"><button type="button" class="btn btn-success">Print</button></a>
								<?php }?>
							</td>
