...
if ($_SESSION['userName'] == '' && $_SESSION['userPassword'] == '')
{
	...
	$content = "<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 290mm;'>
				...
				<p style='width: 290mm; text-align: center; font-size: 10pt;'><b><u>Laporan Laba dan Proyeksi Kerugian</u></b> <br><span style='font-size: 9pt;'>$yr</span></p>
				<br>
				<table cellpadding='0' cellspacing='0' style='width: 290mm;'>
					...
					";
						...
						for ($i = 01; $i <= 12; $i++){
							...
							$queryProfit = "SELECT SUM(trxTotal) as trxTotal, SUM(trxTotalModal) as trxTotalModal FROM as_sales_transactions WHERE trxDate LIKE '$year%'";
					...
					$content .= "
						...
						";
							...
							for ($i = 01; $i <= 12; $i++){
								...
								$payQuery = "SELECT SUM(debtPay) as payTotal FROM as_debts_payment WHERE debtDate LIKE '$year%'";
