...
if ($_SESSION['userName'] == '' && $_SESSION['userPassword'] == '')
{
	...
	$content = "<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 203mm;'>
				...
				<table cellpadding='0' cellspacing='0' style='width: 210mm;'>
					...
					// showing the account
					$queryAccount = "SELECT * FROM as_accounts ORDER BY accountName ASC";
					...
					while ($dtAccount = mysqli_fetch_array($sqlAccount))
					{
						...
						$content .= "
							<tr valign='top'>
								...
								<td style='padding: 5px 0px 5px 0px; font-size: 10pt;'>$dtAccount[accountCode]</td>
								<td style='padding: 5px 0px 5px 0px; font-size: 10pt;'>$dtAccount[accountName]</td>
								<td style='padding: 5px 0px 5px 0px; font-size: 10pt;'>$dtAccount[accountStatus]</td>
							</tr>
						";
						$i++;
					}
